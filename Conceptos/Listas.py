#Clase número 8 Introducción a las Listas/Arreglos
...
#Imprimiendo a partir del elemento con indice: 
print(cadenas[2:])

#imprimiento a partir del elemento con indice X, una cantidad Y de elementos tomando en cuenta los elementos anteriores al inicial
print(cadenas[1:3])
